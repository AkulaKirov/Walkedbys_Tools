    ...
    Private Sub ButGo_Click() Handles ButGo.Click
        ...
        开始工作(Pn, False, Sub()
                            ...
                            Else
                                ...
                                Else
                                    Dp(s)
                                    日志("登录失败！Cookie可能已经失效！请去浏览器获取新 Cookie 。返回数据的长度：" & s.Length)
                                    结束工作()
                                End If
                            End If
                            ...
                            Do While True
                                ...
                                End If
                            Loop
                            日志("采集完成，一共： " & ListIDs.Items.Count & " 条微博。")
                            日志("开始一条一条地删除。")
