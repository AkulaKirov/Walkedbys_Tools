...
Public Class SMD骨骼修整器
    ...
    Private Sub ButClearOtherTexture_Click(sender As Object, e As EventArgs) Handles ButClearOtherTexture.Click
        ListOtherMaterial.Items.Clear()
    End Sub
